...
{
    public partial class Form1 : Form//Form 1
    {
        public Form1()//Form 1
        {
            InitializeComponent();
        ...
        public void Visible(bool a)//Para hacer visible
        {
            lista.Visible = a;
            listBox1.Visible = a;
            listBox2.Visible = a;
        ...
        private void PrintList(List<Nodo> p1)//Imprimir Lista de adyacencia
        {
            ...
            for (int i = 0; i < p1.Count; i++)
            {
                ...
                listBox1.Items.Insert(i, auxiliar);
                auxiliar = null;
            }
        }
        private void PrintStack(Stack<string> s1)//Imprimir Pila de adyacencia
        {
            int j = 0;
            ...
            for (int i = aux.Length-1; i >= 0; i--)
            {
                ...
                listBox2.Items.Insert(j, aux[i]);
                j++;
            }
        }
        private void button1_Click_1(object sender, EventArgs e)//Boton 1 click
        {
            string[] n;
            Nodo aux;
        ...
        private void Pila(List<Nodo> p1, Stack<string> s1)//Pila
        {
            string op;
        ...
        private void button21_Click(object sender, EventArgs e)//Funcion Borrar
        {
            textBox1.Clear();
