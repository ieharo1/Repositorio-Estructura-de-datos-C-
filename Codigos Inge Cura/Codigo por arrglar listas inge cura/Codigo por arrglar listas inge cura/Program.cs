...
namespace LSE
{
    ...
    public class ListaSimple
    {
        ...
        public void RetiraComienzo()
        {
            ...
            {
                Console.WriteLine("Lista Vacia no es posible Retirar un Nodo del Inicio");
            }
        }
        ...
        public void RetiraFinal()
        {
            ...
            else
            {
                ...
                anterior.AgregaSiguienteNodo(null);
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Retira al Comienzo:");
            ...
            Console.WriteLine("Retira al final:");

            miLista2.RetiraFinal();
